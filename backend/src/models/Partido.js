...
export const Partido = sequelize.define('Partido', {
  ...
  periodo_actual: { type: DataTypes.INTEGER, defaultValue: 0, comment: '0=no iniciado, 1=primer tiempo, 2=segundo, etc' },
  ...
  mejor_jugador_id: { type: DataTypes.INTEGER, allowNull: true, comment: 'Persona elegida como mejor jugador del partido' },
  calificacion_arbitro: { type: DataTypes.INTEGER, allowNull: true, comment: 'Calificacion 1-5 estrellas' },
  comentario_arbitro: { type: DataTypes.TEXT, allowNull: true },
  config_override: { type: DataTypes.JSONB, defaultValue: {}, comment: 'Overrides de reglas del torneo para este partido' },
