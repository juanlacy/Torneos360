 ...
 * Cada jugador de la lista de buena fe que participa en el partido
...
export const PartidoAlineacion = sequelize.define('PartidoAlineacion', {
  ...
  jugador_id: { type: DataTypes.INTEGER, allowNull: false },
  ...
  indexes: [
    ...
    { name: 'idx_alineacion_jugador', fields: ['jugador_id'] },
    { name: 'idx_alineacion_unique', fields: ['partido_id', 'jugador_id'], unique: true },
  ],
});
