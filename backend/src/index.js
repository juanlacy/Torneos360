...
import rolesStaffRoutes from './routes/rolesStaff.js';
...
app.use('/instituciones', apiLimiter, institucionesRoutes);
app.use('/personas',  apiLimiter, personasRoutes);
app.use('/jugadores', apiLimiter, jugadoresRoutes);
app.use('/staff',     apiLimiter, staffRoutes);
app.use('/roles-staff', apiLimiter, rolesStaffRoutes);
