      ...
      <mat-card class="w-full max-w-md !bg-slate-900 !border !border-slate-700">
        <mat-card-header class="!justify-center !mb-6">
          <div class="text-center w-full">
            ...
            <p class="text-slate-400 text-sm">Recuperar contrasena</p>
          </div>
        </mat-card-header>
        ...
        <mat-card-content>
          @if (!sent) {
            <form (ngSubmit)="onSubmit()" class="space-y-4">
              <p class="text-slate-400 text-sm">Ingresa tu email y te enviaremos un enlace para restablecer tu contrasena.</p>
            ...
            <div class="text-center">
              <mat-icon class="!text-5xl text-green-400 mb-4">mark_email_read</mat-icon>
              <p class="text-slate-300">Si el email existe, recibiras un enlace para restablecer tu contrasena.</p>
            </div>
          }
